...
class View:
    ...
    def show_menu(self):
        ...
        self.show_message('2. Generating `randomized` data (only for "Readers")')
    ...
    def show_search(self):
        self.show_message("\nSearch:")
        self.show_message("1. Authors who wrote the most books.")
        self.show_message("2. The number of books returned by readers.")
        self.show_message("3. Top of the cheapest books.")
    ...
    def show_top_authors(self, rows):
        print("\nTop authors:")
        for row in rows:
            print(
                f"Name: {row[0]}, Surname: {row[1]}, Book count: {row[2]}")

    def show_returned_books(self, rows):
        print("\nReturned books:")
        for row in rows:
            print(
                f"ID user: {row[0]}, Name: {row[1]}, Surname: {row[2]}, Returned books count: {row[3]}")

    def show_cheapest_books(self, rows):
        print("\nCheapest_books:")
        for row in rows:
            print(
                f"ISBN: {row[0]}, Title: {row[1]}, Author: {row[2]}, Price: {row[3]}")
